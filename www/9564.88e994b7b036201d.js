...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  ...
  {
    9564: (N, x, d) => {
      d.r(x), d.d(x, { ReceiptPageModule: () => B });
      var g = d(6895),
        s = d(4006),
        o = d(8779),
        u = d(9299),
      ...
      let v = (() => {
        class a {
          ...
          filterItems(n) {
            ...
            this.filteredItems = this.const_data.data.filter((i) =>
              i.itemname.toLowerCase().includes(e),
            );
          }
          openItem(n) {
                    ...
                    (this.const_data = n || []),
                      (this.filteredItems =
                        null === (e = this.const_data) || void 0 === e
                          ...
                          : e.data),
                      this.addItemInList(
                        (null === (i = this.const_data) || void 0 === i
                          ? void 0
                          : i.data) || [],
                      ),
                      console.log(
                        null === (r = this.const_data) || void 0 === r
                          ? void 0
                          : r.data,
                      ),
                      (this.Loading = !0);
              ...
              setTimeout(
                () =>
                  (0, f.mG)(this, void 0, void 0, function* () {
                    var e;
                    yield null === (e = this.const_data) || void 0 === e
                      ? void 0
                      : e.data.forEach((i) => {
                          this.checkedItems.forEach((r) => {
                            r.itemcode === i.itemcode && (i.checked = !0);
                          });
                        });
                  }),
                1e3,
          ...
          addlist(n) {
            var e, i, r;
            const p = this.checkedItems.find((l) => l.itemcode === n?.itemcode),
              m = this.checkedItems.findIndex(
                (l) => l.itemcode === n?.itemcode,
              );
            null === (e = this.const_data) ||
              void 0 === e ||
              e.data.find((l) => l.itemcode === n?.itemcode),
              p?.itemcode.toLowerCase() !== n?.itemcode.toLowerCase()
                ? (this.checkedItems.push(n),
                  null === (i = this.const_data) ||
                    void 0 === i ||
                    i.data.forEach((l) => {
                      this.checkedItems.forEach((G) => {
                        G.itemcode === l.itemcode &&
                          ((l.checked = !0), (l.quantity = 1));
                      });
                    }))
                : (this.checkedItems.splice(m, 1),
                  null === (r = this.const_data) ||
                    void 0 === r ||
                    r.data.forEach((l) => {
                      n.itemcode === l.itemcode &&
                        ((l.checked = !1), (l.quantity = 1));
                    }));
          }
        }
        return (
      ...
      function k(a, c) {
        if (
          (1 & a &&
            (t.TgZ(0, "mat-option", 18, 19)(2, "span"),
            t._uU(3),
            t.qZA(),
            t._uU(4, " | "),
            t.TgZ(5, "small"),
      ...
      function E(a, c) {
        if (1 & a) {
          const n = t.EpF();
          t.TgZ(0, "ion-item", 20)(1, "ion-avatar", 0),
            t._UZ(2, "img", 21),
            t.qZA(),
            t.TgZ(3, "ion-col", 22)(4, "ion-row", 23)(5, "p", 24),
            t._uU(6),
            t.qZA(),
            t.TgZ(7, "p", 25),
            t._uU(8),
            t.qZA()(),
            t.TgZ(9, "ion-row", 26)(10, "p", 27),
            t._uU(11, "Quantity: "),
            t.qZA(),
            t.TgZ(12, "ion-input", 28, 29),
            t.NdJ("change", function (i) {
              const p = t.CHM(n).$implicit,
                m = t.MAs(13),
                h = t.oxw();
              return t.KtG(h.total(i, m.value, p.itemcode));
            }),
            t.qZA()(),
            t.TgZ(14, "ion-row", 30)(15, "p", 27),
            t._uU(16, "Kho: "),
            t.qZA(),
            t.TgZ(17, "ion-select")(18, "ion-item-option")(19, "p"),
            t._uU(20, "option 1"),
            t.qZA()()()()()();
        }
        if (2 & a) {
      ...
      function S(a, c) {
        if (1 & a) {
          ...
          t.TgZ(0, "ion-content")(1, "ion-toolbar")(2, "ion-title"),
            t._uU(3, "Ch\u1ecdn kho c\u1ea7n nh\u1eadp"),
            t.qZA()(),
            t.TgZ(4, "ion-list", 31)(5, "ion-radio-group", 32, 33),
            t.YNc(7, U, 4, 2, "ion-item", 34),
            t.qZA()(),
            ...
            class a {
              constructor(n, e, i, r, p, m, h) {
                (this.activatedRoute = n),
                  ...
                  (this.API_RECEIPT = "/receipt"),
                  (this.API_BP = "/business"),
                  (this.BASE_SERVERS = _.r.BASE_SERVER + "/"),
                  (this.imgDefault =
                    "../../../../assets/images/imgdefault.jpeg"),
                  (this.myControlCardCode = new s.NI(""));
              }
              ngOnInit() {
                (this.currentUser = this.authService.getParseTokenUser()),
                  this.loaddata_bp(),
              ...
              openModal() {
                return (0, f.mG)(this, void 0, void 0, function* () {
                  ...
                  yield n.present();
                  const { data: e, role: i } = yield n.onWillDismiss();
                  "confirm" === i && (this.const_data = e);
                });
              }
              total(n, e, i) {
                this.const_data.forEach((r) => {
                  r.itemcode === i && (r.quantity = Number(e));
                });
              }
              cancel_1() {
                return this.modalCtrl.dismiss(null, "cancel");
              ...
              openHistoryItem() {
                this.navCtrl.navigateForward([w.w9.receiptHistory]);
              }
              autocompateCardCode() {
              ...
              _filterCardCode(n) {
                ...
                return this.const_bp.data.filter((i) =>
                  i.cardname.toLowerCase().includes(e),
                );
              }
              onSelectionChange(n) {
                const e = this.const_bp.data.find(
                  (i) => i.cardcode === n.option.value,
                );
            ...
            return (
              ...
              (a.ɵcmp = t.Xpm({
                ...
                viewQuery: function (n, e) {
                  if ((1 & n && (t.Gf(o.ki, 5), t.Gf(R, 5)), 2 & n)) {
                    let i;
                    t.iGM((i = t.CRH())) && (e.modal = i.first),
                      t.iGM((i = t.CRH())) && (e.valuesinput = i.first);
                  }
                },
                decls: 33,
                vars: 8,
                ...
                template: function (n, e) {
                  if (
                    (1 & n &&
                      ...
                      t._UZ(9, "ion-icon", 3),
                      t.qZA()(),
                      t.TgZ(10, "ion-button", 2),
                      t.NdJ("click", function () {
                        return e.openModal();
                      }),
                      t._UZ(11, "ion-icon", 4),
                      t.qZA()()()(),
                      t.TgZ(12, "ion-content")(13, "form", 5)(
                        14,
                        "mat-form-field",
                        6,
                      )(15, "mat-label"),
                      ...
                      t.qZA(),
                      t._UZ(17, "input", 7),
                      t.TgZ(18, "mat-autocomplete", 8, 9),
                      t.NdJ("optionSelected", function (r) {
                        return e.onSelectionChange(r);
                      }),
                      t.YNc(20, k, 7, 3, "mat-option", 10),
                      t.ALo(21, "async"),
                      t.qZA()(),
                      t.TgZ(22, "mat-form-field", 11)(23, "mat-label"),
                      t._uU(24, "T\xean"),
                      t.qZA(),
                      t._UZ(25, "input", 12),
                      t.qZA()(),
                      t.TgZ(26, "ion-list", 13),
                      t.YNc(27, E, 21, 4, "ion-item", 14),
                      t.qZA(),
                      t.TgZ(28, "ion-footer", 15)(29, "button", 16),
                      t._uU(30, "L\u01b0u"),
                      t.qZA()(),
                      t.TgZ(31, "ion-modal", 17),
                      t.YNc(32, S, 10, 1, "ng-template"),
                      t.qZA()()),
                    2 & n)
                  ) {
                    const i = t.MAs(19);
        ...
        },
        {
          ...
          loadChildren: () =>
            d
              .e(8592)
              .then(d.bind(d, 5957))
              .then((a) => a.ReceiptHistoryPageModule),
        },
      ];
      let J = (() => {
        class a {}
        return (
          ...
          (a.ɵmod = t.oAB({ type: a })),
          (a.ɵinj = t.cJS({ imports: [u.Bz.forChild(q), u.Bz] })),
          a
        );
      })();
      var F = d(5064),
      ...
      let B = (() => {
        ...
        return (
          ...
          (a.ɵmod = t.oAB({ type: a })),
          (a.ɵinj = t.cJS({ imports: [g.ez, s.u5, o.Pc, F.q, s.UX, J, L.h] })),
          a
        );
      })();
    },
