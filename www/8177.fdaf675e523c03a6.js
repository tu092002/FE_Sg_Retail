...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  ...
  {
    8177: (Z, c, s) => {
      s.r(c), s.d(c, { BusinessAddPageModule: () => C });
      var u = s(6895),
        i = s(4006),
        o = s(8779),
        l = s(9299),
      ...
      function f(n, r) {
        1 & n &&
          (t.TgZ(0, "div", 14)(1, "div", 15), t._UZ(2, "div", 16), t.qZA()());
      }
      const A = [
        {
          path: "",
            ...
            class n {
              ...
              createForm() {
                this.formGroup = this.formBuilder.group({
                  cardcode: [null, i.kI.required],
                  cardname: [null, i.kI.required],
                  group: [null, i.kI.required],
              ...
              confirm(e) {
                var a, d;
                (this.const_data.cardcode = e.cardcode),
                  (this.const_data.cardname = e.cardname),
                  (this.const_data.group = e.group.toString()),
                  ...
                  (this.const_data.useradd =
                    null === (a = this.currentUser) || void 0 === a
                      ? void 0
                      : a.username),
                ...
                template: function (e, a) {
                  1 & e &&
                    ...
                    t.NdJ("click", function () {
                      return a.confirm(a.formGroup.value);
                    }),
                    t._uU(8, "Th\xeam"),
                    t.qZA()()()(),
                    ...
                    t._uU(17, "Nh\xf3m"),
                    t.qZA(),
                    t.TgZ(18, "ion-select", 8)(19, "ion-select-option", 9),
                    t._uU(20, "Nh\xe0 cung c\u1ea5p"),
                    t.qZA(),
                    t.TgZ(21, "ion-select-option", 10),
                    t._uU(22, "Kh\xe1ch h\xe0ng"),
                    t.qZA()()(),
                    t.TgZ(23, "ion-item")(24, "ion-label", 6),
                    t._uU(25, "\u0110\u1ecba ch\u1ec9"),
                    t.qZA(),
                    t._UZ(26, "ion-input", 11),
                    t.qZA(),
                    t.TgZ(27, "ion-item")(28, "ion-label", 6),
                    t._uU(29, "S\u1ed1 \u0111i\u1ec7n tho\u1ea1i"),
                    t.qZA(),
                    t._UZ(30, "ion-input", 12),
                    t.qZA()()(),
                    t.YNc(31, f, 3, 0, "div", 13)),
                    2 & e &&
                      (t.xp6(7),
                      t.Q6J("strong", !0),
                      t.xp6(3),
      ...
      let C = (() => {
        ...
        return (
          ...
          (n.ɵmod = t.oAB({ type: n })),
          (n.ɵinj = t.cJS({ imports: [u.ez, i.u5, o.Pc, v.q, i.UX, P] })),
          n
        );
      })();
    },
