...
@Component({
  selector: "app-baocaotonghop-nhapkho",
  templateUrl: "./baocaotonghop-nhapkho.page.html",
  styleUrls: ["./baocaotonghop-nhapkho.page.scss"],
})
export class BaocaotonghopNhapkhoPage implements OnInit {
